...
cam={
pos=vec2(0,0),	lerp=0.15,	update=function(self,track_pos)
...
songs={0},	currentsong=-1,	startplayingnow=function(self,songn,f,chmsk)
...
},	anims=nil,	statemachine=nil,	name="player",	spd=0.5,	jump_force=2,	currentanim="default",	topspd=2,
jumped_at=0,	num_jumps=0,	max_jumps=1,	jumping=false,	can_jump=true,	jump_delay=0.5,	jump_cost=25,	jump_pressed=false,	jump_newly_pressed=false,	dead=false,	on_hold=false,	on_chalkhold=false,	chalkhold=nil,	has_chalk=false,	holding=false,	stamina=100,	max_stamina=100,	stamina_regen_rate=2,	stamina_regen_cor=nil,	input=function(self)
if btn(input.r) then
...
levels={
{
name="Level 1",		width=2,		height=4,		spawn={
screen=vec2(1,0),			pos=vec2(6*8,6*8)
},		screens={
{
vec2(0,0),				vec2(-1,-1),				vec2(-1,-1),				vec2(-1,-1)
},			{
...
sprites=nil, life=4, draw=function(self)
...
ends={
c_particle:new({
p=vec2(32,20), v=vec2(-20,0), g=0, m=1
}), c_particle:new({
p=vec2(32,40), v=vec2(20,0), g=5, m=1
})
}, ks=1, kd=0.1, ideal =30
})
add(particles,s1)
end
}
...

...

__gff__
...

...

__sfx__
000300003005030050300503c0503c0503c0503c0503c0503c0503c0403c0403c0303c0303c0203c0203c0103c0103c0103c0103c0103c0103c0103c0103c0103c01000000000000000000000000000000000000
...
00110000260300000026030000002603000000210300000028030000000000000000000000000026030280302a03000000280300000026030000002a030000002803000000000000000000000000000000000000
...

...

